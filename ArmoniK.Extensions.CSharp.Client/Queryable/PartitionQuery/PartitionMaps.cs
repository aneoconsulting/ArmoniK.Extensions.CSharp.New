  ...
  public static readonly Dictionary<string, Type> MemberName2Type_ = new()
                                                                      {
                                                                        ...
                                                                        {
                                                                          nameof(Partition.PodMax), typeof(int)
                                                                        },
                                                                        {
                                                                          nameof(Partition.PodReserved), typeof(int)
                                                                        },
                                                                        {
                                                                          nameof(Partition.PreemptionPercentage), typeof(int)
                                                                        },
                                                                        {
                                                                          nameof(Partition.Priority), typeof(int)
                                                                        },
                                                                        {
                                                                          nameof(Partition.ParentPartitionIds), typeof(IEnumerable<string>)
                                                                        },
                                                                      };
}
